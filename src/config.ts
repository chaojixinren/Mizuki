...
export const siteConfig: SiteConfig = {
	title: "超級の新人's Blog",
	subtitle: "xinren's blog",
	siteURL: "https://chaojixin.ren/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-01-9", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/chaojixinren",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/475702818",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to 超級の新人的博客!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/chaojixinren", // 关于链接
	},
};
